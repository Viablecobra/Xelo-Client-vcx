...
public class XboxDeviceKey {
    ...
    public static XboxDeviceKey restoreKeyAndId(@NotNull Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences("com.origin.launcher.xal.crypto", Context.MODE_PRIVATE);
    ...
    public boolean storeKeyPairAndId(@NotNull Context context, String id) {
        ...
        SharedPreferences.Editor edit = context.getSharedPreferences("com.origin.launcher.xal.crypto", Context.MODE_PRIVATE).edit();
