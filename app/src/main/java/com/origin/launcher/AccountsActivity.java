...
import com.origin.launcher.Adapter.AccountsAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginLauncher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), result -> {
            if (result.getResultCode() == RESULT_OK && result.getData() != null) {
                ...
                if (code != null && codeVerifier != null) {
                    ...
                    loadingDialog = com.origin.launcher.DialogUtils.ensure(this, loadingDialog);
                    com.origin.launcher.DialogUtils.showWithMessage(loadingDialog, getString(R.string.ms_login_exchanging));
                    ...
                    executor.execute(() -> {
                        ...
                        try {
                            ...
                            runOnUiThread(() -> com.origin.launcher.DialogUtils.showWithMessage(loadingDialog, getString(R.string.ms_login_auth_xbox_device)));
                            MsftAuthManager.XboxAuthResult xbox = MsftAuthManager.performXboxAuth(client, token, this);

                            runOnUiThread(() -> com.origin.launcher.DialogUtils.showWithMessage(loadingDialog, getString(R.string.ms_login_fetch_minecraft_identity)));
        ...
        adapter.setOnAccountActionListener(new AccountsAdapter.OnAccountActionListener() {
            ...
            public void onSetActive(MsftAccountStore.MsftAccount account) {
                ...
                if (withinSevenDays) {
                    runOnUiThread(() -> {
                        com.origin.launcher.DialogUtils.dismissQuietly(loadingDialog);
                ...
                loadingDialog = com.origin.launcher.DialogUtils.ensure(AccountsActivity.this, loadingDialog);
                com.origin.launcher.DialogUtils.showWithMessage(loadingDialog, getString(R.string.ms_login_auth_xbox_device));
